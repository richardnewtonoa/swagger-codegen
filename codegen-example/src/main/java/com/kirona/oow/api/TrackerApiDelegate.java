...
/**
 * A delegate to be called by the {@link TrackerApiController}}.
...
public interface TrackerApiDelegate {
    ...
    /**
     * @see TrackerApi#getConfiguration
     */
    default ResponseEntity<Map<String, String>> getConfiguration( String  organisationId,
         String  licenseKey) {
    ...
    /**
     * @see TrackerApi#update
     */
    default ResponseEntity<String> update( String  licenseKey,
